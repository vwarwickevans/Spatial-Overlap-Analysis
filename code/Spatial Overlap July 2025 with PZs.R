...
nam<-paste("2013_2018_s",scenario,"winterwhales_withPZs",sep="")
...
for(i in months){
  ...
  if(month==6|month==7|month==8|month==9){
    shape<-readOGR( ".../JUNESEPT.shp")
  }

  if(month==10|month==11 ){
    shape<-readOGR( ".../OCTNOV.shp")
    
  }
  
  if(month==12|month==1|month==2){
    shape<-readOGR( ".../DECFEB.shp")
  }
  
  
  if(month==3){
    shape<-readOGR( ".../MARCH.shp")
  }
  if(month==4|month==5){
    shape<-readOGR( ".../APRILMAY.shp")
  }
